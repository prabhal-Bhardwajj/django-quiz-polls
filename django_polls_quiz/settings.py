"""
Django settings for django_polls_quiz project.
...
SECRET_KEY = 'django-insecure-l@!cxd3$hsr88jw24zw3m=ekik%zsk@k-dp)^z2(66gljurd2v'
...
ROOT_URLCONF = 'django_polls_quiz.urls'
...
WSGI_APPLICATION = 'django_polls_quiz.wsgi.application'
